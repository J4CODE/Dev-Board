...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      // This will create and save the card
      const newCard = new Card({ title });
      const card = await newCard.save();

      // This assigns the card to the list
...
// This will get all of a list's cards
...
// This will edit a card's title, description, and/or label
...
// This will archive/unarchive a card
